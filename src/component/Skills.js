                ...
                <div className="container">
                    ...
                    <div className="skills_container">
                        ...
                        <ul className="skills_list">
                            ...
                            <li className="skills_item"><span><i className="fab fa-sass"></i>Sass</span></li>
                        ...
                        <ul className="skills_list">
                            ...
                            {/* <li className="skills_item"><span><i className="icon-flask"></i>Flask</span></li> */}
                        ...
                        {/* <h3 className="skills_heading">Database</h3>
                        <ul className="skills_list">
                            <li className="skills_item"><span><i className="devicon-mongodb-plain"></i>MongoDB</span></li>
                            <li className="skills_item"><span><i className="devicon-mysql-plain"></i>MySql</span></li>
                        </ul> */}
                        ...
                        <ul className="skills_list">
                            ...
                            <li className="skills_item"><span><i className="fab fa-linux"></i>Linux</span></li>
                        </ul>
