        ...
        return (
            ...
            <div className = 'about row'>
                <div className = 'about-text col-md-6 col-sm-6 col-xs-12 '>
                    ...
                    <p>I am a software engineer persuing Computer Science and Engineering at the <span style={{color: '#ea4141'}}><strong>Indian Institute of Information Technology(IIIT), Jabalpur</strong></span></p>
                </div>
